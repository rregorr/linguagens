...
public class Resolucao {
    ...
    private integer id_resolucao;

    @ManyToOne //Indica relacionamento muitos-para-um com Pessoa e Questao. Muitas resoluções podem ser feitas pela mesma pessoa.
  ...
  /* A entidade Resolucao tem um atributo questao do tipo Questao (classe Java). O JPA vai gerar na tabela resolucao uma coluna 
  chamada id_questao. Essa coluna será uma chave estrangeira (FK) que aponta para questao(id_questao). */  
